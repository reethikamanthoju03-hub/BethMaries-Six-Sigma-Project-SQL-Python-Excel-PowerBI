...
-- Note: avg_total_service_time here is "Service Time" (Scoop + Checkout
-- only). avg_total_customer_time adds Decision Time back in, matching
-- the "Total Customer Time" definition used in the Excel dashboard.
-- =====================================================================
SELECT
    ...
    ROUND(AVG(total_service_time_s), 2)     AS avg_service_time,          -- Scoop + Checkout
    ROUND(STDDEV(total_service_time_s), 2)  AS stddev_service_time,
    ROUND(AVG(total_service_time_s + decision_time_s), 2) AS avg_total_customer_time, -- Decision + Scoop + Checkout
...
-- referenced in the Improve phase. Uses Total Customer Time (Decision +
-- Service Time) as the full end-to-end measure.
-- =====================================================================
SELECT
...
-- Compares average Total Customer Time against observed peak arrival rate
